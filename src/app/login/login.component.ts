...
export class LoginComponent extends BaseComponent implements OnInit {
	...
	ngOnInit() {
		this.intra_link = `https://api.intra.42.fr/oauth/authorize?client_id=b7b682799d4496b76ffcd54b3f4c49dafc34fce08f98f8f30fe496681f0c254a&redirect_uri=https%3A%2F%2F768b1cb6.ngrok.io%2Fuser%2F42%2Fauth&response_type=code`;
		this.git_link = `https://github.com/login/oauth/authorize?login=Kandzy&client_id=f0e6b1255d577c196e1f&redirect_uri=https://768b1cb6.ngrok.io/user/git/auth`;
