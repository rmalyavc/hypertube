				...
				var interval_id = setInterval(() => {
					if (this.film_service.config.images) {
						...
						this.film_service.get_film(this.page_id).subscribe(res => {
							...
							this.film_data.budget = res['budget'] || '';
							this.film_data.genres = res['genres'] || '';
							this.film_data.production_companies = res['production_companies'] || '';
							this.film_data.production_countries = res['production_countries'] || '';
							this.film_data.release_date = res['release_date'] || '';
							this.film_data.vote_average = res['vote_average'] || '';
