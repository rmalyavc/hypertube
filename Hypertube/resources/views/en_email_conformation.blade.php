            ...
            <table>
                ...
                <tr>
                    <td class="content">
                        ...
                        <h2>Hi <?php echo $data['user']->login ?>,</h2>

                        <p>Before continue please confirm your email address.</p>

                        <table>
                            <tr>
                                <td align="center">
                                    <p>
                                        <a href="<?php echo "http://localhost:4200/register/verify/".$data['additionalData']['verify_token']; ?>" class="button">Confirm Email address</a>
                                    </p>
                                </td>
                            </tr>
                        </table>
